    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header bg-gelap">
                    <h5 class="card-title mb-0 text-white">
                        <i class="fas fa-chart-line"></i> Jumlah Produk Terjual Bulan Ini
                    </h5>
                </div>
                <div class="card-body text-center">
                    <h3 class="text-gelap">1,500 botol</h3>
                    <small class="text-muted">Target: 2,000 botol</small>
                </div>
            </div>
        </div>
        <div class="col-md-6 mb-4" data-aos="fade-left">
            <div class="card">
                <div class="card-header bg-gelap">
                    <h5 class="card-title mb-0 text-white">
                        <i class="fas fa-trophy"></i> Produk Terlaris Bulan Ini
                    </h5>
                </div>
                <div class="card-body text-center">
                    <h3 class="text-gelap">Madu Botol Sedang</h3>
                    <small class="text-muted">450 botol terjual</small>
                </div>
            </div>
        </div>
    </div>
...
<style>
    .jumbotron {
        ...
        display: flex;
        align-items: center;
        background-image: linear-gradient(rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url('{{ asset('assets/landingpage/images/banner.png') }}');
