                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="confirmation-card payment-instructions-card">
                            <div class="card-header {{ $isTripayPayment ? 'tripay-header' : 'manual-header' }}">
                                <h6 class="mb-0">
                                    @if($paymentChannel)
                                    @if($paymentChannel->icon_url)
                                    <img src="{{ $paymentChannel->icon_url }}" alt="{{ $paymentChannel->name }}" class="payment-icon me-2">
                                    @else
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-info">
                                    <small>
                                        Debug: isTripay={{ $isTripayPayment ? 'true' : 'false' }}, 
                                        hasInstructions={{ !empty($paymentInstructions) ? 'true' : 'false' }}, 
                                        instructionCount={{ count($paymentInstructions ?? []) }}
                                    </small>
                                </div>
                                @endif
                                ...
                                <div class="tripay-instructions">
                                    ...
                                    <div class="qris-payment">
                                        ...
                                        <div class="qris-steps">
                                            ...
                                            <div class="instruction-method">
                                                <h6><i class="fas fa-mobile-alt me-2"></i>{{ $instruction['title'] }}</h6>
                                                <ol>
                                    ...
                                    <div class="va-payment">
                                        ...
                                        @if(isset($instruction['title']) && isset($instruction['steps']))
                                        <div class="va-steps">
                                            <h6><i class="fas fa-university me-2"></i>{{ $instruction['title'] }}</h6>
                                            <ol>
                                                @foreach($instruction['steps'] as $step)
                                                <li>{{ $step }}</li>
                                                @endforeach
                                ...
                                <div class="manual-instructions">
                                    ...
                                    <h6><i class="fas fa-info-circle me-2"></i>{{ $paymentInstructions['title'] }}</h6>
                                    @endif
